...
def process_signal(input_signal, window_size=20):
    ...
    Returns:
        Filtered signal
    """
    # Add logic to decide between different filtering algorithms
...
def generate_test_signal(length=1000, noise_level=0.3, seed=42):
    ...
    This is used as a unit test. The full evaluation includes
    multiple test signals with different signal characteristics.
...
def run_signal_processing(signal_length=1000, noise_level=0.3, window_size=20):
    ...
    This is used as a unit test. The full evaluation includes
    multiple test signals with different signal characteristics.
    The evaluation code will directly call the process_signal function.
