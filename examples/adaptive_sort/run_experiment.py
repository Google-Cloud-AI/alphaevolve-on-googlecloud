...
LIB_RS_CONTENT = _load_file("lib.rs")
HELPERS_RS_CONTENT = _load_file("helpers.rs")
...
def main():
    ...
    exp_config = {
        "title": "Adaptive Sort",
        "problem_description": "Evolve a Rust sorting algorithm to be adaptive to different data patterns (random, sorted, reverse, duplicates).",
